...
for i=1:length(Genes2)
    ...
    %figure
    %heatmap(Transitions_m,'Xlabel','Initial State x_0','Ylabel','Final State x_d','Title',['Transitions of TAMCLL-GRN via ',Genes2{1},' (OR operator)'],'ColorbarVisible','off','Colormap',hot)
    ...
    figure
    heatmap(xvalues,yvalues,Cprop,'Xlabel','Initial State x_0','Ylabel','Final State x_d','Title',['Transitions of TAMCLL-GRN via ',Genes2{i},' (OR operator)'],'ColorLimits',[0 100])
end
